...
\emph{The change is confined to the fine-tuned affordances.} Summed over the 19 classes, the mIoU change of 4.26 corresponds to 80.9 points of IoU. The five studied affordances contribute 78.7 of them (97\%), the 13 other affordances contribute $-0.7$, and the background class contributes $+2.9$. The mean IoU of the 13 unstudied classes is 9.22\% before and 9.17\% after fine-tuning. Six of them (lift, support, move, pull, press and stab) have an IoU of zero under both models and therefore carry no information. The other seven change by $-3.1$ to $+3.5$ points (pushable $-3.1$, layable $-1.1$, openable $-0.9$, wrap $+3.5$, listen $+0.6$, displaY $+0.3$, wear $0.0$), and we do not interpret differences of single classes because their noise has not been estimated. This is the check that an update of 101,377 parameters, made with the phrases of five affordances, did not damage the alignment of the affordances that it never rephrased. The same rows show no gain either, so the result gives no evidence that the improvement carries over to affordances that were not fine-tuned.
